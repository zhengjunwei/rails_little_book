...
打开config/application.rb，找到`require 'rails/all'` 替换成下面的require(这个自行参考一下rails版本，在最新的rails 4.2里test_unit已经不是默认使用的了)：
```
...
加入这个仅仅是为了让大家熟悉一下Gemfile还有rails框架的结构，以及稍后我们会简单介绍下rspec，真正的使用内容过多，附录里面会给出一些内容，如果大家感兴趣可以自行去https://github.com/dchelimsky/rspec 和 https://github.com/thoughtbot/factory_girl 继续深入了解。
